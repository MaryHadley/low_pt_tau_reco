...
labelPruned = ("genParticles") #different from the full-on LowPtTaumatcher, the GS does not have pruned, but I'm leaving the label to avoid having to make extra replacements in the code and instead just noting here that pruned in this code is NOT actually pruned
...
handleMET = Handle ("std::vector<reco::GenMET>") #edited for GS
labelMET = ("genMetTrue") #edited for GS
