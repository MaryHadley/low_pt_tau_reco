...
#    if nTot > 1000: break
    ...
    if tag_taum: #one in from overall event loop
        ...
        print "vis_taum_lv.Px() before rotation is:", vis_taum_lv.Px()
        print "vis_taum_lv.Py() before rotation is:", vis_taum_lv.Py()
        print "vis_taum_lv.Pz() before rotation is:", vis_taum_lv.Pz()
